...
if(!CModule::IncludeModule('arsenalpay.second'))
{
...
*/
// For example:
$KEY       = COption::GetOptionString('arsenalpay.second','key');
$IP_ALLOW  = COption::GetOptionString('arsenalpay.second','ip_adress');
